...
import { Shield, Mail, Lock, User, AlertCircle, ArrowLeft, Sun, Moon } from "lucide-react";
...
export const RegisterPage: React.FC = () => {
  ...
  return (
    <div id="register-page" className="min-h-screen bg-bg-light dark:bg-bg-dark text-slate-800 dark:text-slate-200 flex flex-col justify-center items-center p-4 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            Secure your personal SafeHer space and set up emergency circles
          </p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400">
          ...
          <Link id="register-login-link" to="/login" className="font-bold text-accent hover:underline">
            Log In
          </Link>
        </p>
      </div>
